...
if __name__ == '__main__':
    ...
    r_filename = args.reflectance if args.reflectance else './static/reflect/' + base + '.png'
    s_filename = args.shading if args.shading else './static/mask/' + base + '-s.png'
    ...
    input = IntrinsicInput.from_file(
        './static/original/' + image_filename,
        image_is_srgb=sRGB,
